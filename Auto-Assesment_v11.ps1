<#
  .SYNOPSIS
    Perform an assessment for an Exchange hybrid migration.
  .DESCRIPTION
    This script does the following:
     -Active Directory informations
     -DCDiag
     -Exchange Server configuration details
     -Mailbox info
     -distribution group info
     -check for previous hybrid
     -run delegation check script
...
#endregion -- Reports - Output Paths
...
#endregion -- Check Paths ####

#region -- Move Files from previous runs ####
...
#endregion -- Move Files from previous runs ####

#Check Connectivity to Exchange Remote PowerShell
try {
...
#$LastLogonOlderThan = 90
#endregion -- Variables

#region.....Report Arrays
...
#region -- Exchange Server Configurations
#Exchange Server Info
...
#endregion -- Exchange Server Configurations

#region -- Exchange Server Feature Info ####
